...
pub fn base_gas_cost(opcode: u8) -> Option<u64> {
    match opcode {
        ...
        | CHAINID | SELFBALANCE | PC | GAS | MSIZE | BASEFEE => Some(GAS_VERYLOW),
...
mod tests {
    ...
    fn memory_expansion_cost_works() {
        ...
        let cost1 = ((1) * GAS_MEMORY as usize) as u64 + ((1*1)/512) as u64;
